...
input_place = "/home/philipp/Documents/BachelorProjectInput/pynpoint/"
output_place = "/home/Dropbox/Dropbox/1_Philipp/1_UZH/8_FS19/BachelorProject/PynPoint/output"
...
plt.colorbar()
plt.savefig(os.path.join(output_place, "residuals_pca_5_pynpoint.png"), bbox_inches='tight')
...
plt.ylabel('Dec. offset [arcsec]', fontsize=12)
plt.colorbar()
plt.savefig(os.path.join(output_place, "residuals_ipca_%i_%i.png"%(rank_ipca_init, rank_ipca_end)), bbox_inches='tight')
